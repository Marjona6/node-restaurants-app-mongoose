...
function generateCuisineType() {
  var cuisines = ['Italian', 'Thai', 'Colombian'];
...
describe('Restaurants API resource', function () {
  ...
  // on proving something small
    ...
    it('should return all existing restaurants', function () {
      ...
      var res = void 0;
      return chai.request(app).get('/restaurants').then(function (_res) {
    ...
    it('should return restaurants with right fields', function () {
      ...
      var resRestaurant = void 0;
      return chai.request(app).get('/restaurants').then(function (res) {
        res.should.have.status(200);
        res.should.be.json;
  ...
  describe('POST endpoint', function () {
    ...
    it('should add a new restaurant', function () {
      ...
      var newRestaurant = generateRestaurantData();
      var mostRecentGrade = void 0;

      return chai.request(app).post('/restaurants').send(newRestaurant).then(function (res) {
        ...
        mostRecentGrade = newRestaurant.grades.sort(function (a, b) {
  ...
  describe('PUT endpoint', function () {
    ...
    it('should update fields you send over', function () {
      ...
      return Restaurant.findOne().exec().then(function (restaurant) {
        updateData.id = restaurant.id;

        // make request then inspect it to make sure it reflects
        // data we sent
        return chai.request(app).put('/restaurants/' + restaurant.id).send(updateData);
      }).then(function (res) {
  ...
  describe('DELETE endpoint', function () {
    ...
    it('should delete a restaurant by id', function () {
      ...
      return Restaurant.findOne().exec().then(function (_restaurant) {
